...
public class UserContext: DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        userInit.Add(new User() {  Nombres = "Edison Esteban", Apellidos = "Isaza López", Usuario = "eisaza", Correo = "edisonisaza@gmail.com"});
        userInit.Add(new User() {  Nombres = "Yoamin Estiven", Apellidos = "Jaramillo Munera", Usuario = "yjaramillo", Correo = "correo@gmail.com"});
